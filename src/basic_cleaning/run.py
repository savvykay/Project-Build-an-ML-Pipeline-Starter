...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type=str,
        help="The name of the input artifact in W&B (e.g., sample.csv:latest)",
        required=True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type=str,
        help="The name of the output artifact to create (e.g., clean_sample.csv)",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type=float,
        help="The minimum price to consider for listings",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="The maximum price to consider for listings",
        required=True
    )
